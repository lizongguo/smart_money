(function(e) {
	e.Zebra_Tooltips = function(k, p) {
		...
		var n = function(c) {
				...
				if (a.window_resized || a.window_scrolled) d = e(window), a.window_resized && (l = d.width(), u = d.height(), g =
						c.offset(), e.extend(a, {
							element_left: g.left,
							element_top: g.top,
							element_width: c.outerWidth(),
							element_height: c.outerHeight()
						})), r = d.scrollTop(), h = d.scrollLeft(), d = "left" == b.settings.position ? a.element_left - a.tooltip_width +
					a.arrow_width : "right" == b.settings.position ? a.element_left + a.element_width - a.arrow_width : a.element_left +
					(a.element_width - a.tooltip_width) / 2, g = a.element_top - a.tooltip_height, f = "left" == b.settings.position ?
					a.tooltip_width - a.arrow_width - a.arrow_width / 2 : "right" == b.settings.position ? a.arrow_width / 2 : (a.tooltip_width -
						a.arrow_width) / 2, d + a.tooltip_width > l + h && (f -= l + h - (d + a.tooltip_width) - 6, d = l + h - a.tooltip_width -
						6, f + a.arrow_width > a.tooltip_width - 6 && (f = a.tooltip_width - 6 - a.arrow_width), d + f + a.arrow_width /
						2 < a.element_left && (f = -1E4)), d < h && (f -= h - d, d = h + 2, 0 > f && (f = a.arrow_width / 2), d + f + a
						.arrow_width / 2 > a.element_left + a.element_width && (f = -1E4)), a.arrow_container.removeClass(
						"Zebra_Tooltip_Arrow_Top"), a.arrow_container.addClass("Zebra_Tooltip_Arrow_Bottom"), a.message.css(
						"margin-top", ""), a.arrow.css("borderColor", b.settings.background_color + " transparent transparent"), g < r ||
					"below" == b.settings.default_position && a.element_top + a.element_height + b.settings.vertical_offset + a.tooltip_height +
					a.animation_offset < u + r ? (g = a.element_top + a.element_height - b.settings.vertical_offset, a.animation_offset =
						Math.abs(a.animation_offset), a.message.css("margin-top", a.arrow_height / 2), a.arrow_container.removeClass(
							"Zebra_Tooltip_Arrow_Bottom"), a.arrow_container.addClass("Zebra_Tooltip_Arrow_Top"), a.arrow.css(
							"borderColor", "transparent transparent " + b.settings.background_color)) : (a.animation_offset = -Math.abs(a.animation_offset),
						g += b.settings.vertical_offset), a.arrow_container.css("left", f), a.tooltip.css({
						left: d,
						top: g
					}), e.extend(a, {
						tooltip_left: d,
						tooltip_top: g,
						arrow_left: f
					}), a.window_resized = !1, a.window_scrolled = !1, a = e.extend(c.data("Zebra_Tooltip"), a), c.data(
						"Zebra_Tooltip", a);
				return a
			},
			m = function(c) {
