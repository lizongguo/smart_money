...
namespace App\Services\Baidu\sms;

use App\Services\Baidu\sms\SampleSigner;
/*
...
class BaiduSmsClient {
     ...
     *  );
     */
    function __construct($accessKey = null, $secretAccessKey = null, $endPoint = 'sms.bj.baidubce.com') {
        $this->endPoint = !empty($endPoint) ? $endPoint : 'sms.bj.baidubce.com';
