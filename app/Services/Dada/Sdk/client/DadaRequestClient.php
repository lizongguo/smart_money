<?php
namespace App\Services\Dada\Sdk\client;
...
class DadaRequestClient{
    ...
    public function makeRequest(){
        ...
        return $this->parseResponseDada($resp);
    }
    ...
    public function getHttpRequestWithPost($data){
        ...
        if (isset($info['http_code']) && $info['http_code'] == 200) {
            BLogger::getLogger(BLogger::LOG_PEISONG)->info($resp);
            return $resp;
        } else {
            BLogger::getLogger(BLogger::LOG_PEISONG)->error(var_export(curl_error($curl), true));
        }
        return '';
    }
     ...
     */
    public function parseResponseDada($arr){
