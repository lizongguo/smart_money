...
use App\Models\FoundAudit;
use Illuminate\Support\Facades\Auth;
use App\Models\UserFound;
use Excel;

class FoundAuditController extends BaseController
{
    public function __construct(Request $request, FoundAudit $model) {
        parent::__construct();
        $this->model = $model;
    }
