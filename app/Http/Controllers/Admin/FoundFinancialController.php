...
class FoundFinancialController extends BaseController
{
    public function __construct(Request $request, FoundFinancial $model) {
        parent::__construct();
        $this->model = $model;
    }
