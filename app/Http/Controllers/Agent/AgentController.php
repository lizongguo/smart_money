...
class AgentController extends BaseController
{
    ...
    function account() {
        return view('agent.' . $this->viewName . '.account', ['email' => $this->user->email]);
    }
    ...
    function changePassword(Request $request) {
        ...
        return view('agent.' . $this->viewName . '.changePassword', ['email' => $this->user->email]);
    }
    ...
    function changeEmail(Request $request) {
        ...
        return view('agent.' . $this->viewName . '.changeEmail', ['email' => $this->user->email]);
    }
    ...
    function info(Request $request) {
        ...
        return view('agent.' . $this->viewName . '.info', ['data' => $company]);
    }
