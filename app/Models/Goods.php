...
class Goods extends BaseModel
{
    ...
    {
        return $this->belongsToMany(Shops::class, 'goods_shops', 'goods_id', 'shop_id')->where('shops.deleted', 0);
    }
    ...
    /**
     * Log belongs to GoodsSpecs.
     *
     * @return BelongsTo
     */
    public function goods_specs() : HasMany
    {
        return $this->hasMany('App\Models\GoodsSpecs', 'goods_id', 'id')->where('deleted', 0);
    }
