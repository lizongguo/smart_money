    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="imgTpl"> 
                <img style="display: inline-block; width: 50%; height: 100%;" src="{{config('app.url')}}@{{ d.thumb }}">
            </script>
...
layui.config({
    ...
    table.render({
        ...
        , url: '{{route("ads.items")}}' //模拟接口
        , cols: [[
                {type: 'checkbox', fixed: 'left'}
                , {field: 'id', width: 100, title: 'ID', sort: true}
                , {field: 'name', title: '标题', minWidth: 500}
                , {field: 'thumb', width: 200, title: '图片',templet: '#imgTpl'}
                , {field: 'type_id', width: 150, title: '类型', templet: '#typeNameTpl', sort: true}
                , {field: 'state', width: 100, title: '公开状态', templet: '#stateNameTpl', sort: true}
    ...
    var deleteUri = "{{route('ads.delete', ['id' => '_id'])}}";
    var editUri = "{{route('ads.input', ['id' => '_id'])}}";
