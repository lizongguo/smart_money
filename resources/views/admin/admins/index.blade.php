...
<div class="layui-fluid">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="number" name="sh[id]" placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">邮箱</label>
                    <div class="layui-input-block">
                        <input type="text" name="sh[email]" placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
    ...
    layui.config({
        ...
        table.render({
            ...
            , url: '{{route("admins.items")}}' //模拟接口
            , cols: [[
                    {type: 'checkbox', fixed: 'left'}
                    , {field: 'id', width: 100, title: 'ID', sort: true}
                    , {field: 'name', title: '角色名', minWidth: 100}
                    , {field: 'email', title: '邮箱'}
                    , {field: 'role', title: '角色', sort: true, templet: '#roleNameTpl'}
        ...
        var deleteUri = "{{route('admins.delete', ['id' => '_id'])}}";
        var editUri = "{{route('admins.input', ['id' => '_id'])}}";
