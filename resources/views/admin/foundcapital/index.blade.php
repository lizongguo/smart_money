...
layui.config({
    ...
    table.render({
        ...
        , url: '{{route("capital.items", ['found_no' => $found_no])}}' //模拟接口
        , cols: [[
                {field: 'id', width: 100, title: '编号', sort: true},
                {field: 'uname', title: '认缴人', width: 100},
                {field: 'type_val', title: '类型', width: 100},
                {field: 'amount_cn', title: '认缴金额(人民币)', width: 200},
                {field: 'amount_us', title: '认缴金额(美元)', width: 200},
                {field: 'paid_date', title: '认缴时间', width: 200},
    ...
    var deleteUri = "{{route('capital.delete', ['id' => '_id'])}}";
    var editUri = "{{route('capital.input', ['id' => '_id', "found_no" => $found_no, ])}}";
    //排序功能
