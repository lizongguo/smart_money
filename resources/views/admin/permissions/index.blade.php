...
layui.config({
    ...
    table.render({
        ...
        , url: '{{route("permissions.items")}}' //模拟接口
        , cols: [[
                {type: 'checkbox', fixed: 'left'}
                , {field: 'id', width: 100, title: 'ID', sort: true}
                , {field: 'name', title: '权限名', minWidth: 100}
                , {field: 'slug', title: '标示'}
                , {field: 'http_method', width: 160, title: 'HTTP方法'}
                , {field: 'http_path', width: 300, title: 'HTTP路径'}
    ...
    var deleteUri = "{{route('permissions.delete', ['id' => '_id'])}}";
    var editUri = "{{route('permissions.input', ['id' => '_id'])}}";
