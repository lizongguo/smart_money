    ...
    <div class="layui-card">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="sh[company_name]" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="table-admin-opation">
                <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="risk"><i class="layui-icon layui-icon-edit"></i>项目风险</a>
...
layui.config({
    ...
    table.render({
        ...
        , url: '{{route("project.items")}}' //模拟接口
        , cols: [[
                {field: 'project_no', width: 100, title: '编号', sort: true},
                {field: 'company_name', title: '公司名称', width: 250},
                {field: 'company_name_eng', title: '公司英文名称', width: 250},
                {field: 'address', title: '公司地址)', width: 380},
                {field: 'website', title: '官网', width: 300},
                {field: 'state_val_str', title: '公司状态', width: 100},
                {field: 'state', title: '状态描述', width: 200},
                {field: 'listed_val', title: '上市市值', width: 200},
                {field: 'shares_url', title: '股价链接', width: 200},
    ...
    var editUri = "{{route('project.input', ['id' => '_id'])}}";
    var riskUri = "{{route('project.risk', ['id' => '_id'])}}";//风险提示
