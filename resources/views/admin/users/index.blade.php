    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="imgTpl">
                @{{#  if(d.avatar != ''){ }}
                <img style="display: inline-block; width: 30px; height: 30px;" src= @{{ d.avatar }}>
                @{{#  } }}
...
layui.config({
    ...
    table.render({
        ...
        , url: '{{route("users.items")}}' //模拟接口
        , cols: [[
//                {type: 'checkbox', fixed: 'left'}
                {field: 'user_id', width: 100, title: 'ID', sort: true}
                , {field: 'email', title: '账号', width: 120}
                , {field: 'name', title: '投资人', width: 180}
                , {field: 'phone', title: '手机号', width: 150}
                , {field: 'tzemail', title: '邮箱', width: 250}
