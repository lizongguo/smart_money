...
layui.config({
    ...
    table.render({
        ...
        , url: '{{route("users.founditems")}}' //模拟接口
        , cols: [[
                {field: 'user_id', width: 100, title: 'ID', sort: true}
                , {field: 'name', title: '投资人', width: 120}
                , {field: 'email', title: '前台账号', width: 120}
                , {field: 'email_info', title: '邮箱', width: 180}
                , {field: 'phone', title: '手机号', width: 150}
                , {field: 'address', title: '邮寄地址', width: 250}
                , {field: 'tel_phone', title: '电话号码', width: 150}
                , {field: 'recipient', title: '收件人', width: 100}
    ...
    var deleteUri = "{{route('users.delete', ['id' => '_id'])}}";
    var editUri = "{{route('users.input', ['id' => '_id'])}}";
