    ...
    layui.config({
        ...
        table.render({
            ...
            , cols: [[
                    ...
                    , {field: 'name', width:'20%', title: '基金名称'}
                    , {field: 'code',width:'15%', title: '基金代码'}
                    , {field: 'ranking',width:'15%', title: '排名'}
                    , {field: 'fund_type',width:'15%', title: '类型'}
                    , {title: '操作', width: '20%', align: 'center', fixed: 'right', toolbar: '#table-admin-opation'}
                ]]
            , page: true
            , limit: 30
            , height: 'full-220'
