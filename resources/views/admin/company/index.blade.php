    ...
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
                ...
                {{--</div>--}}
                <div class="layui-inline">
                    <label class="layui-form-label">企業名</label>
                    <div class="layui-input-block">
                        <input type="text" name="sh[company_name]" placeholder="企業名" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
...
layui.config({
    ...
    table.render({
        ...
        , url: '{{route("company.items")}}' //模拟接口
        , cols: [[
//                {type: 'checkbox', fixed: 'left'}
                {field: 'id', width: 80, title: 'ID', sort: true}
                , {field: 'company_name', title: '企業名', width: 200}
                , {field: 'type', title: 'タイプ', width: 160}
                , {field: 'resume_count', title: '毎日スカウト数', width: 120}
    ...
    var deleteUri = "{{route('company.delete', ['id' => '_id'])}}";
    var editUri = "{{route('company.input', ['id' => '_id'])}}";
