...
<head>
  ...
  <link type="text/css" href="{{asset('/css/zebra_tooltips.css')}}" rel="stylesheet" />
    ...
    <div class="user_menu">
      @if ($userInfo)
        ...
        <ul class="user_sub_menu">
          <li>
              <ul>
                <li><a href="{{ route("web.index.logout") }}"><i class="fa fa-sign-out "> </i> 退出登录</a></li>
              </ul>
          </li>
        </ul>
      @else
      <div class="login_link"><a href="{{ route("web.index.login") }}"><i class="fa fa-user-circle-o"></i>ログイン</a></div>
      @endif
    </div>
    <script>
