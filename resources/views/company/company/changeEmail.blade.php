...
@section('content')
        ...
        <div class="my_setting">
            ...
            <form id="resume_add">
                <ul class="my_setting_list">
                    ...
                    <li>
                        <p>現在のパスワード:</p>
                        <p><input type="password" class="input_text" data-min="6" data-max="12" name="password" placeholder="" required autocomplete="new-password"/></p>
                    </li>
                    <div class="pop_btn">
    ...
    <script>
        $("#resume_add").html5Validate(function() {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('company.user.changeEmail') }}",
                dataType: "json",
                    ...
                    layer.open({
                        ...
                        yes: function(index) {
                            ...
                            if (content.status == 200) {
                                window.location.href = "{{ route('company.user.account') }}";
                                //window.history.back();
                            }
                        }
                    });
