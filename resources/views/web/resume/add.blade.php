...
@section('content')
    <div class="main">
        <div class="logo_box">
            ...
            <p>日本で就業希望の外国人（国内外在住）の方々にお仕事を紹介しております。</p>
        </div>
                    ...
                    <ul>
                        ...
                        <div class="stepbox1">
                            ...
                            <li class="resume_item_input">
                                <input type="text" class="input_text" maxlength="50" value="" name="name" placeholder="" required />
                            </li>
                            ...
                            <li class="birthday_select">
                                <input type="text" autocomplete="off" readonly data-format="yyyy-mm-dd" data-start-view="4" data-min-view="2" name="birthday" class="input_text birthday_date" required>
                            </li>
                ...
                <div class="ad_main">
                    <div class="ad_box">
                        <a href="/juku">
                            ...
                            <p>「日本就職塾」は、日本企業へ就職したい外国人向けオンラインレッスンサービスです。講師は全員日本人。面接対策、履歴書・職務経歴書の書き方等をオンラインでレッスンします。</p>
                        </a>
                    </div>
                </div>
    ...
    <script>
        ...
        $("#resume_add").html5Validate(function() {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('web.resume.validatorItem') }}",
                dataType: "json",
                data: {"email":email},
