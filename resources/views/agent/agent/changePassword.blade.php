        ...
        <div class="my_setting">
            ...
            <form id="resume_add">
                <ul class="my_setting_list">
                    <li>
                        <p>現在のパスワード:</p>
                        <p><input type="password" class="input_text" value="" name="password_old" data-min="6" data-max="12" placeholder="" required /></p>
                    </li>
                    <li>
                        <p>新しいパスワード:</p>
    ...
    <script>
        $("#resume_add").html5Validate(function() {
            ...
            if (password_new_confirm != password_new) {
                ...
                $.ajax({
                    type: "post",
                    url: "{{ route('agent.user.changePassword') }}",
                    dataType: "json",
                        ...
                        layer.open({
                            ...
                            yes: function(index) {
                                ...
                                if (content.status == 200) {
                                    //window.location.href = "{{ route('agent.user.index') }}";
                                    window.history.back();
                                }
                            }
                        });
